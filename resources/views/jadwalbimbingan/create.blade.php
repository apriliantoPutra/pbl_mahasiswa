                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('jadwal-bimbingan-magang.index') }}" class="btn btn-tool"><i
                                        class="fas fa-arrow-alt-circle-left"></i></a>
                            </div>
                        </div>
                        <form action="{{ route('jadwal-bimbingan-magang.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
